...
public class TrainingPlayer extends Player {
    ...
    public TrainingPlayer(int x, int y, Color c, String map,MapFrame frame) {
        super(x, y);
        this.color = c;
    ...
    public void up(){
        mapFrame.purp = mapFrame.trainingPlayerSS.getImage(3,1,32,32);
        if(jumpCounter < 2){
            ySpeed = 6;
            jumpCounter++;
        }
    ...
    public void left(){
        mapFrame.purp = mapFrame.trainingPlayerSS.getImage(1,3,32,32);
        xSpeed = -1;
    }

    public void right(){
        mapFrame.purp = mapFrame.trainingPlayerSS.getImage(1,2,32,32);
        xSpeed = 1;
    }
...
//      }
    ...
    public void lightAttack(){
        mapFrame.purp = mapFrame.trainingPlayerSS.getImage(2,4,32,32);
        lightAttacking = true;
    }
