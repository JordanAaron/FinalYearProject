...
public class Orange extends Player {
    ...
    public Orange(int x, int y, Color c, String map, MapFrame frame) {
        super(x, y);
        this.color = c;
    ...
    public void up(){
        mapFrame.orange = mapFrame.orangeSS.getImage(2,1,32,32);
        if(jumpCounter < 2){
            ySpeed = 6;
            jumpCounter++;
        }
    ...
    public void left(){
        mapFrame.orange = mapFrame.orangeSS.getImage(2,2,32,32);
        xSpeed = -1;
    }

    public void right(){
        mapFrame.orange = mapFrame.orangeSS.getImage(1,2,32,32);
        xSpeed = 1;
    }
    ...
    public void stopMoving(){
        mapFrame.orange = mapFrame.orangeSS.getImage(1,1,32,32);
        canMove = false;
    }
...
//      }
    ...
    public void lightAttack(){
        mapFrame.orange = mapFrame.orangeSS.getImage(1,3,32,32);
        lightAttacking = true;
    }
